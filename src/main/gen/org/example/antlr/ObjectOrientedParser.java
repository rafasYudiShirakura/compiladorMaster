...
public class ObjectOrientedParser extends Parser {
	...
	public static final int
		...
		LINE_COMMENT=62, BLOCK_COMMENT=63, WS=64, NEW=65, PACKAGE=66, IMPORT=67, 
		EXTENDS=68, IMPLEMENTS=69, INTERFACE=70, ENUM=71, PROTECTED=72, STATIC=73, 
		ABSTRACT=74, NATIVE=75, SYNCHRONIZED=76, TRANSIENT=77, VOLATILE=78, BYTE=79, 
		SHORT=80, SUPER=81, THROWS=82, DEFAULT=83, ELLIPSIS=84, VAR=85, ASSERT=86, 
		WHILE=87, DO=88, TRY=89, SWITCH=90, THROW=91, BREAK=92, CONTINUE=93, CATCH=94, 
		FINALLY=95, CASE=96, THIS=97, NULL_LITERAL=98, ARROW=99, LSHIFT_ASSIGN=100, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"XOR_ASSIGN", "MOD_ASSIGN", "LINE_COMMENT", "BLOCK_COMMENT", "WS", "NEW", 
			...
			"FINALLY", "CASE", "THIS", "NULL_LITERAL", "ARROW", "LSHIFT_ASSIGN", 
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 511L) != 0)) {
				{
				{
				setState(187);
				typeDeclaration();
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 28L) != 0) || ((((_la - 72)) & ~0x3f) == 0 && ((1L << (_la - 72)) & 127L) != 0)) {
				{
				{
				setState(220);
				modifier();
	...
	public final ModifierContext modifier() throws RecognitionException {
		...
		try {
			...
			setState(272);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 28L) != 0) || ((((_la - 72)) & ~0x3f) == 0 && ((1L << (_la - 72)) & 127L) != 0)) ) {
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 287313918L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 2047L) != 0)) {
				{
				{
				setState(337);
	...
	public final InterfaceBodyContext interfaceBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 270536702L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 2047L) != 0)) {
				{
				{
				setState(362);
	...
	public final InterfaceMethodDeclarationContext interfaceMethodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2101212L) != 0) || ((((_la - 72)) & ~0x3f) == 0 && ((1L << (_la - 72)) & 511L) != 0)) {
				{
				setState(394);
				formalParameterList();
				}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 263934355378144L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 12885016577L) != 0)) {
				{
				setState(485);
				variableInitializer();
				setState(490);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 263934623866878L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 13420855265L) != 0)) {
				{
				{
				setState(601);
				blockStatement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 10:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 263934338600928L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 12885016577L) != 0)) {
					{
					setState(691);
					expression();
					}
	...
	public final ForControlContext forControl() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 263934338600944L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 12886065153L) != 0)) {
					{
					setState(744);
					forInit();
					}
