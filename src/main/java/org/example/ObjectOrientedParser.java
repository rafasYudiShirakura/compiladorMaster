...
public class ObjectOrientedParser extends Parser {
	...
	public static final int
		CLASS=1, INTERFACE=2, ENUM=3, EXTENDS=4, IMPLEMENTS=5, PUBLIC=6, PRIVATE=7, 
		PROTECTED=8, STATIC=9, FINAL=10, ABSTRACT=11, NATIVE=12, SYNCHRONIZED=13, 
		TRANSIENT=14, VOLATILE=15, VOID=16, BOOLEAN=17, BYTE=18, CHAR=19, SHORT=20, 
		INT=21, LONG=22, FLOAT=23, DOUBLE=24, STRING_TYPE=25, IF=26, ELSE=27, 
		WHILE=28, FOR=29, DO=30, SWITCH=31, CASE=32, DEFAULT=33, BREAK=34, CONTINUE=35, 
		RETURN=36, NEW=37, THIS=38, SUPER=39, NULL_LITERAL=40, INSTANCEOF=41, 
		PACKAGE=42, IMPORT=43, THROWS=44, TRY=45, CATCH=46, FINALLY=47, ASSERT=48, 
		BOOLEAN_LITERAL=49, INTEGER_LITERAL=50, FLOAT_LITERAL=51, CHAR_LITERAL=52, 
		STRING_LITERAL=53, IDENTIFIER=54, LPAREN=55, RPAREN=56, LBRACE=57, RBRACE=58, 
		LBRACK=59, RBRACK=60, SEMI=61, COMMA=62, DOT=63, ELLIPSIS=64, AT=65, COLONCOLON=66, 
		...
		ARROW=101, LINE_COMMENT=102, BLOCK_COMMENT=103, WS=104, VAR=105, THROW=106, 
		LSHIFT=107, RSHIFT=108, URSHIFT=109;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'class'", "'interface'", "'enum'", "'extends'", "'implements'", 
			"'public'", "'private'", "'protected'", "'static'", "'final'", "'abstract'", 
			"'native'", "'synchronized'", "'transient'", "'volatile'", "'void'", 
			"'boolean'", "'byte'", "'char'", "'short'", "'int'", "'long'", "'float'", 
			"'double'", "'String'", "'if'", "'else'", "'while'", "'for'", "'do'", 
			"'switch'", "'case'", "'default'", "'break'", "'continue'", "'return'", 
			"'new'", "'this'", "'super'", "'null'", "'instanceof'", "'package'", 
			"'import'", "'throws'", "'try'", "'catch'", "'finally'", "'assert'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "CLASS", "INTERFACE", "ENUM", "EXTENDS", "IMPLEMENTS", "PUBLIC", 
			"PRIVATE", "PROTECTED", "STATIC", "FINAL", "ABSTRACT", "NATIVE", "SYNCHRONIZED", 
			"TRANSIENT", "VOLATILE", "VOID", "BOOLEAN", "BYTE", "CHAR", "SHORT", 
			"INT", "LONG", "FLOAT", "DOUBLE", "STRING_TYPE", "IF", "ELSE", "WHILE", 
			"FOR", "DO", "SWITCH", "CASE", "DEFAULT", "BREAK", "CONTINUE", "RETURN", 
			"NEW", "THIS", "SUPER", "NULL_LITERAL", "INSTANCEOF", "PACKAGE", "IMPORT", 
			"THROWS", "TRY", "CATCH", "FINALLY", "ASSERT", "BOOLEAN_LITERAL", "INTEGER_LITERAL", 
			"FLOAT_LITERAL", "CHAR_LITERAL", "STRING_LITERAL", "IDENTIFIER", "LPAREN", 
			...
			"URSHIFT_ASSIGN", "ARROW", "LINE_COMMENT", "BLOCK_COMMENT", "WS", "VAR", 
			"THROW", "LSHIFT", "RSHIFT", "URSHIFT"
		};
	}
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65486L) != 0)) {
				{
				{
				setState(187);
				typeDeclaration();
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2467972595832586190L) != 0)) {
				{
				{
				setState(337);
	...
	public final InterfaceBodyContext interfaceBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2323857407756730318L) != 0)) {
				{
				{
				setState(362);
	...
	public final InterfaceMethodDeclarationContext interfaceMethodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18014398542970816L) != 0)) {
				{
				setState(394);
				formalParameterList();
				}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 215611893778153472L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 15363L) != 0)) {
				{
				setState(485);
				variableInitializer();
				setState(490);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2521771686693437390L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 103079230467L) != 0)) {
				{
				{
				setState(601);
				blockStatement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 10:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71496705702297600L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 15363L) != 0)) {
					{
					setState(691);
					expression();
					}
	...
	public final ForControlContext forControl() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71496705702298624L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 34359753731L) != 0)) {
					{
					setState(744);
					forInit();
					}
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(827);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 17452548067688448L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AssignmentExpressionContext assignmentExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 17171480577L) != 0)) {
				{
				{
				setState(912);
				assignmentOperator();
	...
	public final AssignmentOperatorContext assignmentOperator() throws RecognitionException {
		...
		try {
			...
			setState(920);
			_la = _input.LA(1);
			if ( !(((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 17171480577L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final RelationalExpressionContext relationalExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 41)) & ~0x3f) == 0 && ((1L << (_la - 41)) & 51942260737L) != 0)) {
				{
				setState(983);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
				...
				case GE:
					...
					setState(979);
					_la = _input.LA(1);
					if ( !(((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 387L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ShiftExpressionContext shiftExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 107)) & ~0x3f) == 0 && ((1L << (_la - 107)) & 7L) != 0)) {
				{
				{
				setState(989);
				_la = _input.LA(1);
	...
	public final MultiplicativeExpressionContext multiplicativeExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 84)) & ~0x3f) == 0 && ((1L << (_la - 84)) & 35L) != 0)) {
				{
				{
				setState(1005);
				_la = _input.LA(1);
				if ( !(((((_la - 84)) & ~0x3f) == 0 && ((1L << (_la - 84)) & 35L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final PostfixExpressionContext postfixExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 59)) & ~0x3f) == 0 && ((1L << (_la - 59)) & 6291473L) != 0)) {
				{
				setState(1065);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
